        ...
        function opts(opt) {
            for (let opt in options) {
                ...
                if (opt.type == "boolean") {
                    ...
                    option.value = xml({raw: ["=", ""],cooked: ["=", ""]}, [(template.highlight(opt.value))]);
                yield option;
            }
        };
        ...
        function prefs() {
            for (let pref of prefArray) {
                ...
                let option = {
                    ...
                    value:     xml({raw: ["", ""],cooked: ["", ""]}, [(template.highlight(value, true, 100))]),
                    name:      pref,
                    pre:       "\u00a0\u00a0" // Unicode nonbreaking space.
                };
            ...
            for (let [, arg] in args) {
                ...
                // read access
                    ...
                    if (opt.all)
                        ...
                        liberator.echo(xml({raw: ["<span highlight=\"CmdOutput\">", "</span>"],cooked: ["<span highlight=\"CmdOutput\">", "</span>"]}, [(msg)]));
                    }
                }
                // write access
                        ...
                        ", "\n\
                            ...
                            template.map2(xml, liberator.globalVariables, function ([i, value]) {
                                ...
                                return xml({raw: ["<tr>\n\
                                            ...
                                            <td>", "", "</td>\n\
                                       </tr>"],cooked: ["<tr>                                            <td style=\"width: 200px;\">", "</td>                                            <td>", "", "</td>                                       </tr>"]}, [(i), (prefix), (value)]);
                            })
                        )]);
                    if (hasRow)

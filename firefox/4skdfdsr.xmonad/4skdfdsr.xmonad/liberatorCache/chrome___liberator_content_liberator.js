                    ...
                    if (count > 1) {
                        ...
                        let str = template.genericOutput("Code execution summary",
                                xml({raw: ["<table>\n\
                                    ...
                                    <tr><td>Average time:</td><td align=\"right\"><span class=\"time-average\">", "</span></td><td>", "</td></tr>\n\
                                    <tr><td>Total time:</td><td align=\"right\"><span class=\"time-total\">", "</span></td><td>", "</td></tr>\n\
                                </table>"],cooked: ["<table>                                    <tr><td>Executed:</td><td align=\"right\"><span class=\"times-executed\">", "</span></td><td>times</td></tr>                                    <tr><td>Average time:</td><td align=\"right\"><span class=\"time-average\">", "</span></td><td>", "</td></tr>                                    <tr><td>Total time:</td><td align=\"right\"><span class=\"time-total\">", "</span></td><td>", "</td></tr>                                </table>"]}, [(count), (each.toFixed(2)), (eachUnits), (total.toFixed(2)), (totalUnits)]));
